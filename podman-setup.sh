#!/bin/bash
# setup.sh - Complete Development Container Setup (Podman Mode - No Systemd)
...
OPENCODE_EOF
    ...
    # 15. NO SYSTEMD SERVICE - Will be started manually
    echo "==> Skipping systemd service setup (Podman mode)"
    echo "==> Neovim server will be started by the container script"

    echo ""
    echo "=========================================="
    echo "✅ SETUP COMPLETE!"
    echo "=========================================="
    echo "Neovim server: Will be started on 127.0.0.1:6000"
    echo ""
}
...
if [ "$EUID" -eq 0 ]; then
    ...
    echo "=========================================="
    echo "Development Container Setup (Podman Mode)"
    echo "=========================================="
    echo ""
